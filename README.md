...
1. How would you describe acessibility on the web to someone new to programming?
   ...
   Acessbility means what you are building can be used by as many people as possible, for example, the blind. It is important to do this both to include those people and to make your site easier to use for everyone.

2. Talk about 3 different things you can do to ensure your website is accessible.
   semantic HTML, Alt tags, easy to read formatting and contrasts

3. How would you explain the concept of a variable to someone new to programming?

a variable is a name or object we use to store and reference data to be used by us later.

4. What is the purpose of using functions in code?

   Functions allow us to automate repeatable tasks and keep our code DRY.
